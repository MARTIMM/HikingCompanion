...
*/
	...
	Q_INVOKABLE inline QString getKeyedFilenameFromPart( QString hikeKey, QString fileName ) {
		return _configData->getKeyedFilenameFromPart( hikeKey, fileName);
	}
	...
	Q_INVOKABLE inline void setHikeModel() {
		_configData->setHikeModel();
		emit hikeModelDefined();
	}
	Q_INVOKABLE inline QList<QObject *> hikeModel() {
		return _configData->hikeModel();
	}
